...
const Home = () => {
  ...
  const send = (e)=>{
    ...
    toast.success("Iteam Added to Your Cart")
  }
  return (
    <>
      <section className='iteam_section mt-4 container'>
        <h2 className='px-4' style={{fontWeight: 400}}>Cloud Restaurant Open All The Time</h2>
                  ...
                  <Card style={{width: "22rem", border: "none"}} className='mb-4 hove'>
                      ...
                      <div className="card_body">
                        ...
                        <div className="last_data d-flex justify-content-between align-items-center">
                          ...
                          <img className='lamg' src={element.delimg}/>
                        </div>
                      </div>
                  </Card>
                </>
